...
async function migrate() {
  ...
  try {
    ...
    const mongoStakes = await mongoose.connection.db.collection('stakings').find().toArray();
    ...
    const mongoTrans = await mongoose.connection.db.collection('transactions').find().toArray();
