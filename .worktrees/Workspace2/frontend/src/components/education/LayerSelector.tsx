            ...
            <div className="bg-slate-800 rounded-2xl w-full max-w-lg p-6 border border-slate-700 shadow-2xl">
                ...
                <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                    {(course.layers || []).map((layer) => {
                        ...
                        const progressEntry = userProgress.layerProgress?.find(p => p.layerId === layer.id && p.courseId === course.id.toString());
                        const isCompleted = !!progressEntry;
                        const mastery = progressEntry?.bestScore || 0;
                            ...
                            >
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="flex flex-col items-end gap-2 text-xs text-slate-400">
                                        ...
                                        {mastery > 0 && layer.type !== 'comprehension' && (
