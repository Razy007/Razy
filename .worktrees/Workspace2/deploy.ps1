...
if (-not $FrontendOnly) {
    ...
    Compress-Archive -Path "backend/database","backend/routes","backend/services","backend/middleware","backend/src" -DestinationPath "backend_deploy.zip" -Update -ErrorAction SilentlyContinue
