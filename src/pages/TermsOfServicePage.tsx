  ...
  const content = {
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: `Vous pouvez staker votre Pi pour des périodes fixes (7, 30, ou 90 jours) avec des taux APR de 5%, 10% et 15%. Les fonds stakés sont bloqués jusqu'à l'expiration. Pas de retrait anticipé possible.`
        },
        {
      ...
      contactInfo: {
        ...
        email: "Email",
        emailAddress: "legal@pioneeracademy.academy",
        support: "Support",
    ...
    en: {
      ...
      sections: [
        ...
        {
          title: "6. Staking & APR",
          text: `You can stake your Pi for fixed periods (7, 30, or 90 days) with APR rates of 5%, 10% and 15%. Staked funds are locked until expiration. No early withdrawal available.`
        },
        {
