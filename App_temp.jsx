...
// Simple icon components (replacing lucide-react for CDN compatibility)
const Icon = ({ name, size = 24, className = "" }) => {
  const icons = {
    Trophy: "🏆", Book: "📚", Users: "👥", Star: "⭐", Zap: "⚡", Award: "🏅",
    ChevronRight: "›", Target: "🎯", Brain: "🧠", Shield: "🛡️", Gift: "🎁",
    Flame: "🔥", CheckCircle: "✓", Globe: "🌐", Copy: "📋", Lock: "🔒",
    Crown: "👑", Share2: "📤", TrendingUp: "📈", DollarSign: "$",
    Calendar: "📅", Percent: "%", AlertCircle: "⚠️", X: "✕"
  };
...
const Trophy = (props) => React.createElement(Icon, { ...props, name: "Trophy" });
const Book = (props) => React.createElement(Icon, { ...props, name: "Book" });
const Users = (props) => React.createElement(Icon, { ...props, name: "Users" });
const Star = (props) => React.createElement(Icon, { ...props, name: "Star" });
const Zap = (props) => React.createElement(Icon, { ...props, name: "Zap" });
const Award = (props) => React.createElement(Icon, { ...props, name: "Award" });
const ChevronRight = (props) => React.createElement(Icon, { ...props, name: "ChevronRight" });
const Target = (props) => React.createElement(Icon, { ...props, name: "Target" });
const Brain = (props) => React.createElement(Icon, { ...props, name: "Brain" });
const Shield = (props) => React.createElement(Icon, { ...props, name: "Shield" });
const Gift = (props) => React.createElement(Icon, { ...props, name: "Gift" });
const Flame = (props) => React.createElement(Icon, { ...props, name: "Flame" });
const CheckCircle = (props) => React.createElement(Icon, { ...props, name: "CheckCircle" });
...
const Crown = (props) => React.createElement(Icon, { ...props, name: "Crown" });
const Share2 = (props) => React.createElement(Icon, { ...props, name: "Share2" });
const TrendingUp = (props) => React.createElement(Icon, { ...props, name: "TrendingUp" });
const DollarSign = (props) => React.createElement(Icon, { ...props, name: "DollarSign" });
const Calendar = (props) => React.createElement(Icon, { ...props, name: "Calendar" });
const Percent = (props) => React.createElement(Icon, { ...props, name: "Percent" });
const AlertCircle = (props) => React.createElement(Icon, { ...props, name: "AlertCircle" });
            ...
            <div className="text-center mb-6">
              ...
              <div className="relative inline-block mb-3">
                {profilePicture ? (
                  ...
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-7xl border-4 border-yellow-400 mx-auto">
                    {user?.avatar}
                  </div>
                )}

                {/* Upload Button */}
                <label className="absolute bottom-0 right-0 bg-yellow-400 hover:bg-yellow-500 text-black rounded-full p-2 cursor-pointer transition">
                  <input
                    type="file"
                    accept="image/*"
              ...
              {profilePicture && (
                <button
                  ...
                  className="text-red-400 hover:text-red-300 text-sm mb-2 transition"
                >
                  ✕ Supprimer la photo
                </button>
              )}
