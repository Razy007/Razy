...
export const ApiService = {
  ...
  // Wallet
  validateWallet: (address: string, network: string) => api.post('/wallet/validate', { address, network }),
  saveWallet: (data: { address: string, network: string }) => api.post('/wallet/save', data),
};
