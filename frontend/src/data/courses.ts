...
const RAW_COURSES: BilingualCourse[] = [
    ...
    // ========== 2. WALLET MASTERY ==========
    {
        ...
        difficulty: 'beginner',
        requiredLevel: 1, 
        requiredXP: 150,   // ✅ Adjusted: C1 gives ~160 XP
    ...
    // ========== 3. SECURITY / ANTI-SCAM ==========
    {
        ...
        difficulty: 'beginner',
        requiredLevel: 2,
        requiredXP: 450,   // ✅ Adjusted: C1(160) + C2(305) = 465. 450 is safe.
    ...
    // ========== 4. KYC (UPDATED WITH LAB) ==========
    {
        ...
        requiredLevel: 3, 
        requiredXP: 800,   // ✅ Adjusted: C1+C2+C3(~375) = ~840.
        requiredCourses: ['safety-101'], // ✅ Updated: flow is Wallet -> Safety -> KYC
        layers: [
            {
                id: 'kyc-l1',
                type: 'discovery',
     ...
     // ========== 5. BLOCKCHAIN (UPDATED WITH LAB) ==========
    {
        ...
        requiredLevel: 4, 
        requiredXP: 1200,  // ✅ Adjusted: 840 + C4(375) = 1215. 1200 is safe.
    ...
    // ========== 6. DEFI (UPDATED WITH LAB) ==========
    {
        ...
        requiredLevel: 5, 
        requiredXP: 1650,   // ✅ Adjusted: 1215 + C5(460) = 1675. 1650 is safe.
